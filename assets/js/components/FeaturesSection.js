...
<section class="flex flex-row gap7 justify-spacebetween flex-col-mobile gap3-mobile items-center-mobile">
    <div class="card card--emote">
        ...
        <div class="flex flex-col items-start">
            <span class="card-title" data-i18n="pages.${PAGINA_ATUAL}.highlights.card1.title"></span>
            <span class="card-content" data-i18n="pages.${PAGINA_ATUAL}.highlights.card1.desc"></span>
        </div>
    </div>
    <div class="card card--emote">
    <!-- WORLD/PLANE ICON -->
        ...
        <div class="flex flex-col items-start">
            <span class="card-title" data-i18n="pages.${PAGINA_ATUAL}.highlights.card2.title"></span>
            <span class="card-content" data-i18n="pages.${PAGINA_ATUAL}.highlights.card2.desc"></span>
        </div>
    </div>
    <div class="card card--emote">
        <!-- STACKS ICON -->
        ...
        <div class="flex flex-col items-start">
            <span class="card-title" data-i18n="pages.${PAGINA_ATUAL}.highlights.card3.title"></span>
            <span class="card-content" data-i18n="pages.${PAGINA_ATUAL}.highlights.card3.desc"></span>
        </div>
    </div>
</section>
</div>
